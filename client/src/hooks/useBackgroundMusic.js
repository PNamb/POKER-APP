...
export function useBackgroundMusic() {
    ...
    useEffect(() => {
        ...
        if (isGameScreen) { //if the new screen is the game-screen, stop currently playing music and start game-screen music
            lobbyPlayer.pause()
            gamePlayer.seekTo(0)
            gamePlayer.play()
        } else { //if the new screen is the lobby-screen, stop currently playing music and start lobby-screen music
            gamePlayer.pause()
