...
export function shuffle(deck) {
  //shuffle using fisher-yates algorithim (pick a card before our current card and switch places); returns a deck
  const cards = [...deck];
...
export function deal(deck, n) {
  //deal n cards; returns an object of {cards dealt, remaining cards}
