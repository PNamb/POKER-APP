...
export default function JoinScreen() {
    ...
    const handleBack = () => { //for back button
        router.back()
    }

    const handleJoin = async () => { //for joining a game
        ...
        setTimeout(() => {
            setConnecting(false)
            router.push({pathname: "/lobby", params: {isHost: false, roomCode: code}})
        }, 600)
    }
    const canSubmit = code.length === CODE_LENGTH && !connecting

    return ( //render the join button and enter-code input
